...
if n==k then check the even indices from 2 to n whether it matches or not. if not the print that 
x position.

else it is garunteed that ans will be either 1 or 2 as now we have the rights to make subarray 
as we like. so if the amount of 1 is less than the the diff of n and subarray counts +1 
then the ans will be 2 otherwise it will be 1. 
