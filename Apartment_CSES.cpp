/*
Name of the problem: Apartment
 
 use two pointer approach after sorting each of the array. if desired is less than apartment size , shift the pointer to the next candidate else
 shift to the next apartment cz there is no candidate demanding lower than it. If the condition satisfies with k then count them.
 Atlast print them.
