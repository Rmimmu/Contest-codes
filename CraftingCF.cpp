...
question was easy to understand but tough to implement.
if more than one v1 is less than v2 then it will be no.
if the amount is one then we need to check the minimum diff between 
v2-v1 is greater equal than the gap between v1-v2 or not. 
