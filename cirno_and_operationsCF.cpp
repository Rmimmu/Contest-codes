...
Solution description (if needed): as we see that whether we reverse the array elements or not; it doesn't effect the sum of them as their abs is same.
so we can skip the reverse term and do the rest until the array lenght becomes 1 & compare until then.
