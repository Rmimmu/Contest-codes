...
assume that for every count of the number, there will be that 
much operation will be held 

also after deleting ak-1 and ak+1 , the remaining will be the total count of 
that value multiplied by that valude and the total elements of ak-2 value 
